...
# 6a 1 9a 
acoef[1] = 0.09806   #kl_6a_s1  =   0.09806 , ev
acoef[2] = 0.05033   #kl_1_s1  =   0.05033 , ev
acoef[3] = 0.14521   #kl_9a_s1  =   0.14521 , ev

bcoef[1] = -0.13535  #kl_6a_s2  =  -0.13545 , ev
bcoef[2] = 0.171     #kl_1_s2  =   0.17100 , ev
bcoef[3] = 0.03746   #kl_9a_s2  =   0.03746 , ev
...
ccoef[0] = 0.20804           #lambda =   0.20804 , ev
ccoef = ccoef/au2ev 
...
b2coef = np.zeros((4,4),dtype=np.float64)
                               ...
                               # H(1,1)
a2coef[0,0] = -0.01159         # kq_10a_s1  =  -0.01159 , ev
a2coef[1,1] = 0.0000           # kq_6a_s1  =   0.00000 , ev
a2coef[2,2] = 0.00             # kq_1_s1  =   0.00000 , ev
a2coef[3,3] = 0.00             # kq_9a_s1  =  0.00000 , ev
                                       # H(2,2)
b2coef[0,0] = -0.01159         # kq_10a_s2  =  -0.01159 , ev
b2coef[1,1] = 0.00             # kq_6a_s2  =  0.00000 , ev
b2coef[2,2] = 0.00             # kq_1_s2  =   0.00000 , ev
b2coef[3,3] = 0.00             # kq_9a_s2  =   0.00000 , ev

                             # bilinear, on-diagonal coupling coefficients
                             # H(1,1)
a2coef[1,2] =  0.00108       # kb_6ax1_s1  =   0.00108 , ev
a2coef[2,3] = -0.00474       # kb_1x9a_s1  =  -0.00474 , ev
a2coef[1,3] =  0.00204       # kb_6ax9a_s1  =   0.00204 , ev
                             # H(2,2)
b2coef[1,2] = -0.00298        # kb_6ax1_s2  =  -0.00298 , ev
b2coef[2,3] = -0.00155        # kb_1x9a_s2  =  -0.00155 , ev
b2coef[1,3] =  0.00189       # kb_6ax9a_s2  =   0.00189 , ev
...
c2coef = np.zeros((4,4),dtype=np.float64)
                          ...
                          # H(1,2) and H(2,1)
c2coef[0,2] =  0.00553     #kb_1x10a  =   0.00553 , ev
c2coef[0,1] =  0.01000    #kb_6ax10a  =  0.01000 , ev
c2coef[0,3] =  0.00126     #kb_9ax10a  =   0.00126 , ev
