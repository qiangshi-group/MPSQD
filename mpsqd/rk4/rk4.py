import sys
import numpy as np
from ..utils import add_tensor, prod_tensor_mat
...
def rk4(wave,mat1,delta_t,small=1e-14,nrmax=50,need_trun=True):
  ...
  dwave1 = prod_tensor_mat(mat1,wave,small,nrmax,need_trun)
  wave0 = add_tensor(wave,dwave1,dt2,small,nrmax,need_trun)

  dwave2 = prod_tensor_mat(mat1,wave0,small,nrmax,need_trun)
  wave0 = add_tensor(wave,dwave2,dt2,small,nrmax,need_trun)

  dwave3 = prod_tensor_mat(mat1,wave0,small,nrmax,need_trun)
